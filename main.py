...
class HomeScreen(Screen):
    def __init__(self, **kwargs):
        ...
        name_label1 = Label(text='Welcome To My Portfolio App', font_size=20, color=(0, 0.7, 0.7, 1), markup=True)
        name_label = Label(text='R.MANI BHARATHI-B.E(CSE)', font_size=20, color=(0, 0.7, 0.7, 1), markup=True)
        name_label2 = Label(text='PYTHON DEVELOPER', font_size=20, color=(0, 0.7, 0.7, 1), markup=True)
...
class SkillsScreen(Screen):
    def __init__(self, **kwargs):
        ...
        name_label = Label(text='SKILLS', font_size=20, color=(0, 0.7, 0.7, 1), markup=True)
        ...
        skills_label = Label(text='Proficient in WordPress, HTML, CSS Strong understanding of responsive design principles Familiarity with'
                             ...
                             font_size=16, color=(0.7, 0, 0, 1),markup=True, size_hint_y=None, height=25, text_size=(300, 250))  # Red
...
class ContactUsScreen(Screen):
    def __init__(self, **kwargs):
        ...
        contact_label = Label(text='GMAIL:manibharathi642@gmail.com', font_size=16, color=(0, 0, 0.7, 1))  # Dark blue
        phone_label = Label(text='PHONE NUMBER: +919080571145', font_size=16, color=(0, 0, 0.7, 1))  # Dark blue
        address_label = Label(text='ADDRESS: Tiruvanamalai,606-601', font_size=16, color=(0, 0, 0.7, 1))
        github_label = Label(text='GITHUB:github.com/manibharathi19', font_size=16, color=(0, 0, 0.7, 1))  # Dark blue
        # Button to go back to the home page
        home_button = Button(text='Home', on_press=self.go_to_home_page, background_color=(0.2, 0.2, 0.6, 1))  # Blue
...
class EDUCATIONScreen(Screen):
    def __init__(self, **kwargs):
        ...
        education1_label = Label(text='ANNA UNIVERSITY , S.K.P ENGINEERING COLLEGE , DEPARTMENT --> CSE , CGPA-->85% ',font_size=16, color=(0.7, 0, 0, 1),markup=True, size_hint_y=None, height=25, text_size=(300, 250))  # Dark blue
        # Button to go back to the home page
        home_button = Button(text='Home', on_press=self.go_to_home_page, background_color=(0.2, 0.2, 0.6, 1))  # Blue
...
class CERTIFICATIONScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Display contact information
        certi1_label = Label(text='UDEMY COURSE OF FULL STACK DEVELOPMENT',font_size=14, color=(0.7, 0, 0, 1))  # Dark blue
        certi2_label = Label(text='Oracle Cloud 2023 Foundations Associate',font_size=14, color=(0.7, 0, 0, 1))  # Dark blue
        certi3_label = Label(text='Completed a Month-long Intership At Python Domin',font_size=14, color=(0.7, 0, 0, 1))  # Dark blue
        certi4_label = Label(text='Python Enthusiast, HackerRank 3-Star',font_size=14, color=(0.7, 0, 0, 1))  # Dark blue
        # Button to go back to the home page
        home_button = Button(text='Home', on_press=self.go_to_home_page, background_color=(0.2, 0.2, 0.6, 1))  # Blue
...
class HABITScreen(Screen):
    def __init__(self, **kwargs):
        ...
        habit1_label = Label(text='Detail-oriented: Possess a strong attention to detail,ensuring accuracy and precision in coding and web development tasks.',font_size=14, color=(0.7, 0, 0, 1),markup=True, size_hint_y=None, height=25, text_size=(300, 250))  # Dark blue
...
class PROJECTScreen(Screen):
    def __init__(self, **kwargs):
        ...
        project1_label = Label(text='CREATED A WEBSITE FOR MY DEPARTMENT STUDENTS GENERATING A CLASS TEST RESULTS',font_size=14, color=(0.7, 0, 0, 1),markup=True, size_hint_y=None, height=25, text_size=(300, 250))  # Dark blue
        project2_label = Label(text='SCHOOL MANAGEMENT SYSTEM USING PHP IN INTERSHIP',font_size=11, color=(0.7, 0, 0, 1))  # Dark blue
        project3_label = Label(text='MY PORTFOLIO APP',font_size=14, color=(0.7, 0, 0, 1))  # Dark blue
        # Button to go back to the home page
        home_button = Button(text='Home', on_press=self.go_to_home_page, background_color=(0.2, 0.2, 0.6, 1))  # Blue
